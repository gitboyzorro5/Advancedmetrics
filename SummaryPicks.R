...
#
# df <- tail(UCL_advstats[UCL_advstats$HomeTeam == "Luton" | UCL_advstats$AwayTeam == "Luton",],advstatsn)
#
# df2 <- tail(UCL_advstats[UCL_advstats$HomeTeam == "Burnley" | UCL_advstats$AwayTeam == "Burnley",],advstatsn)
#
# temp_analysis <- rbind(df,df2)
#
# temp_analysis <- as.data.frame(temp_analysis)
...
# temp_analysis <- rbind(temp_analysis,temp_analyis_combined)
#
# write.xlsx(temp_analysis,"Temp/lutonVburnley.xlsx")
