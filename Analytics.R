...
E0Team_goalmins <- sqldf("SELECT HomeTeam,SUM(TGM),SUM(TGM)/10 from E0Team_goalminshomeaway GROUP BY HomeTeam ORDER BY SUM(TGM) DESC")
...
E0Team_Bookings <- sqldf("SELECT HomeTeam,SUM(TBookings),SUM(TBookings)/10 from E0Team_Bookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TBookings) DESC")
...
E0Team_CrossBookings <- sqldf("SELECT HomeTeam,SUM(TCrossBookings),SUM(TCrossBookings)/10 from E0Team_CrossBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TCrossBookings) DESC")
...
E0Team_ShirtsXbookings <- sqldf("SELECT HomeTeam,SUM(TShirtsXbookings),SUM(TShirtsXbookings)/10 from E0Team_ShirtsXbookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TShirtsXbookings) DESC")
...
E0Team_TGMXcorners <- sqldf("SELECT HomeTeam,SUM(TTGMXcorners),SUM(TTGMXcorners)/10 from E0Team_TGMXcornershomeaway GROUP BY HomeTeam ORDER BY SUM(TTGMXcorners) DESC")
...
E0Team_MultiBookings <- sqldf("SELECT HomeTeam,SUM(TMultiBookings),SUM(TMultiBookings)/10 from E0Team_MultiBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TMultiBookings) DESC")
...
E0Team_epl_shirts <- sqldf("SELECT HomeTeam,SUM(Tepl_shirts),SUM(Tepl_shirts)/10 from E0Team_epl_shirtshomeaway GROUP BY HomeTeam ORDER BY SUM(Tepl_shirts) DESC")
...
D1Team_goalmins <- sqldf("SELECT HomeTeam,SUM(TGM),SUM(TGM)/9 from D1Team_goalminshomeaway GROUP BY HomeTeam ORDER BY SUM(TGM) DESC")
...
D1Team_Bookings <- sqldf("SELECT HomeTeam,SUM(TBookings),SUM(TBookings)/9 from D1Team_Bookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TBookings) DESC")
...
D1Team_CrossBookings <- sqldf("SELECT HomeTeam,SUM(TCrossBookings),SUM(TCrossBookings)/9 from D1Team_CrossBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TCrossBookings) DESC")
...
D1Team_ShirtsXbookings <- sqldf("SELECT HomeTeam,SUM(TShirtsXbookings),SUM(TShirtsXbookings)/9 from D1Team_ShirtsXbookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TShirtsXbookings) DESC")
...
D1Team_TGMXcorners <- sqldf("SELECT HomeTeam,SUM(TTGMXcorners),SUM(TTGMXcorners)/9 from D1Team_TGMXcornershomeaway GROUP BY HomeTeam ORDER BY SUM(TTGMXcorners) DESC")
...
D1Team_MultiBookings <- sqldf("SELECT HomeTeam,SUM(TMultiBookings),SUM(TMultiBookings)/9 from D1Team_MultiBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TMultiBookings) DESC")
...
D1Team_bundesliga_shirts <- sqldf("SELECT HomeTeam,SUM(Tbundesliga_shirts),SUM(Tbundesliga_shirts)/9 from D1Team_bundesliga_shirtshomeaway GROUP BY HomeTeam ORDER BY SUM(Tbundesliga_shirts) DESC")
...
I1Team_goalmins <- sqldf("SELECT HomeTeam,SUM(TGM),SUM(TGM)/11 from I1Team_goalminshomeaway GROUP BY HomeTeam ORDER BY SUM(TGM) DESC")
...
I1Team_Bookings <- sqldf("SELECT HomeTeam,SUM(TBookings),SUM(TBookings)/11 from I1Team_Bookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TBookings) DESC")
...
I1Team_CrossBookings <- sqldf("SELECT HomeTeam,SUM(TCrossBookings),SUM(TCrossBookings)/11 from I1Team_CrossBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TCrossBookings) DESC")
...
I1Team_ShirtsXbookings <- sqldf("SELECT HomeTeam,SUM(TShirtsXbookings),SUM(TShirtsXbookings)/11 from I1Team_ShirtsXbookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TShirtsXbookings) DESC")
...
I1Team_TGMXcorners <- sqldf("SELECT HomeTeam,SUM(TTGMXcorners),SUM(TTGMXcorners)/11 from I1Team_TGMXcornershomeaway GROUP BY HomeTeam ORDER BY SUM(TTGMXcorners) DESC")
...
I1Team_MultiBookings <- sqldf("SELECT HomeTeam,SUM(TMultiBookings),SUM(TMultiBookings)/11 from I1Team_MultiBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TMultiBookings) DESC")
...
I1Team_seriea_shirts <- sqldf("SELECT HomeTeam,SUM(Tseriea_shirts),SUM(Tseriea_shirts)/11 from I1Team_seriea_shirtshomeaway GROUP BY HomeTeam ORDER BY SUM(Tseriea_shirts) DESC")
...
SP1Team_goalmins <- sqldf("SELECT HomeTeam,SUM(TGM),SUM(TGM)/12 from SP1Team_goalminshomeaway GROUP BY HomeTeam ORDER BY SUM(TGM) DESC")
...
SP1Team_Bookings <- sqldf("SELECT HomeTeam,SUM(TBookings),SUM(TBookings)/12 from SP1Team_Bookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TBookings) DESC")
...
SP1Team_CrossBookings <- sqldf("SELECT HomeTeam,SUM(TCrossBookings),SUM(TCrossBookings)/12 from SP1Team_CrossBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TCrossBookings) DESC")
...
SP1Team_ShirtsXbookings <- sqldf("SELECT HomeTeam,SUM(TShirtsXbookings),SUM(TShirtsXbookings)/12 from SP1Team_ShirtsXbookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TShirtsXbookings) DESC")
...
SP1Team_TGMXcorners <- sqldf("SELECT HomeTeam,SUM(TTGMXcorners),SUM(TTGMXcorners)/12 from SP1Team_TGMXcornershomeaway GROUP BY HomeTeam ORDER BY SUM(TTGMXcorners) DESC")
...
SP1Team_MultiBookings <- sqldf("SELECT HomeTeam,SUM(TMultiBookings),SUM(TMultiBookings)/12 from SP1Team_MultiBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TMultiBookings) DESC")
...
SP1Team_laliga_shirts <- sqldf("SELECT HomeTeam,SUM(Tlaliga_shirts),SUM(Tlaliga_shirts)/12 from SP1Team_laliga_shirtshomeaway GROUP BY HomeTeam ORDER BY SUM(Tlaliga_shirts) DESC")
...
F1Team_goalmins <- sqldf("SELECT HomeTeam,SUM(TGM),SUM(TGM)/10 from F1Team_goalminshomeaway GROUP BY HomeTeam ORDER BY SUM(TGM) DESC")
...
F1Team_Bookings <- sqldf("SELECT HomeTeam,SUM(TBookings),SUM(TBookings)/10 from F1Team_Bookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TBookings) DESC")
...
F1Team_CrossBookings <- sqldf("SELECT HomeTeam,SUM(TCrossBookings),SUM(TCrossBookings)/10 from F1Team_CrossBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TCrossBookings) DESC")
...
F1Team_ShirtsXbookings <- sqldf("SELECT HomeTeam,SUM(TShirtsXbookings),SUM(TShirtsXbookings)/10 from F1Team_ShirtsXbookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TShirtsXbookings) DESC")
...
F1Team_TGMXcorners <- sqldf("SELECT HomeTeam,SUM(TTGMXcorners),SUM(TTGMXcorners)/10 from F1Team_TGMXcornershomeaway GROUP BY HomeTeam ORDER BY SUM(TTGMXcorners) DESC")
...
F1Team_MultiBookings <- sqldf("SELECT HomeTeam,SUM(TMultiBookings),SUM(TMultiBookings)/10 from F1Team_MultiBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TMultiBookings) DESC")
...
F1Team_ligueone_shirts <- sqldf("SELECT HomeTeam,SUM(Tligueone_shirts),SUM(Tligueone_shirts)/10 from F1Team_ligueone_shirtshomeaway GROUP BY HomeTeam ORDER BY SUM(Tligueone_shirts) DESC")
...
OTHERLEAGUES_analytics <- readxl::read_excel('OTHERLEAGUES20242025.xlsx')
