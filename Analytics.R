...
D2Team_goalmins <- sqldf("SELECT HomeTeam,SUM(TGM),SUM(TGM)/30 from D2Team_goalminshomeaway GROUP BY HomeTeam ORDER BY SUM(TGM) DESC")
...
D2Team_Bookings <- sqldf("SELECT HomeTeam,SUM(TBookings),SUM(TBookings)/30 from D2Team_Bookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TBookings) DESC")
...
D2Team_CrossBookings <- sqldf("SELECT HomeTeam,SUM(TCrossBookings),SUM(TCrossBookings)/30 from D2Team_CrossBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TCrossBookings) DESC")
...
D2Team_TGMXcorners <- sqldf("SELECT HomeTeam,SUM(TTGMXcorners),SUM(TTGMXcorners)/30 from D2Team_TGMXcornershomeaway GROUP BY HomeTeam ORDER BY SUM(TTGMXcorners) DESC")
...
D2Team_MultiBookings <- sqldf("SELECT HomeTeam,SUM(TMultiBookings),SUM(TMultiBookings)/30 from D2Team_MultiBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TMultiBookings) DESC")
...
fifteen_and30 <- sqldf("SELECT Referee,COUNT(*) FROM D2_analytics WHERE Match_First_YCTime BETWEEN '15' AND '30' GROUP BY Referee ORDER BY COUNT(*) DESC")
thirty_and45 <- sqldf("SELECT Referee,COUNT(*) FROM D2_analytics WHERE Match_First_YCTime BETWEEN '30' AND '45' GROUP BY Referee ORDER BY COUNT(*) DESC")
...
write.xlsx(fifteen_and30,'Analytics/D2/RefereeFirstCard_d2.xlsx', sheetName = "fifteen_and30", append = TRUE)
...
Hfifteen_and30 <- sqldf("SELECT HomeTeam,COUNT(*) FROM D2_analytics WHERE Home_First_YCTime BETWEEN '15' AND '30' GROUP BY HomeTeam ORDER BY COUNT(*) DESC")
Hthirty_and45 <- sqldf("SELECT HomeTeam,COUNT(*) FROM D2_analytics WHERE Home_First_YCTime BETWEEN '30' AND '45' GROUP BY HomeTeam ORDER BY COUNT(*) DESC")
...
Afifteen_and30 <- sqldf("SELECT AwayTeam,COUNT(*) FROM D2_analytics WHERE Away_First_YCTime BETWEEN '15' AND '30' GROUP BY AwayTeam ORDER BY COUNT(*) DESC")
Athirty_and45 <- sqldf("SELECT AwayTeam,COUNT(*) FROM D2_analytics WHERE Away_First_YCTime BETWEEN '30' AND '45' GROUP BY AwayTeam ORDER BY COUNT(*) DESC")
...
write.xlsx(Hfifteen_and30,'Analytics/D2/TeamFirstCard_d2.xlsx', sheetName = "Hfifteen_and30", append = TRUE)
...
write.xlsx(Afifteen_and30,'Analytics/D2/TeamFirstCard_d2.xlsx', sheetName = "Afifteen_and30", append = TRUE)
...
E1Team_goalmins <- sqldf("SELECT HomeTeam,SUM(TGM),SUM(TGM)/30 from E1Team_goalminshomeaway GROUP BY HomeTeam ORDER BY SUM(TGM) DESC")
...
E1Team_Bookings <- sqldf("SELECT HomeTeam,SUM(TBookings),SUM(TBookings)/30 from E1Team_Bookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TBookings) DESC")
...
E1Team_CrossBookings <- sqldf("SELECT HomeTeam,SUM(TCrossBookings),SUM(TCrossBookings)/30 from E1Team_CrossBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TCrossBookings) DESC")
...
E1Team_TGMXcorners <- sqldf("SELECT HomeTeam,SUM(TTGMXcorners),SUM(TTGMXcorners)/30 from E1Team_TGMXcornershomeaway GROUP BY HomeTeam ORDER BY SUM(TTGMXcorners) DESC")
...
E1Team_MultiBookings <- sqldf("SELECT HomeTeam,SUM(TMultiBookings),SUM(TMultiBookings)/30 from E1Team_MultiBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TMultiBookings) DESC")
...
fifteen_and30 <- sqldf("SELECT Referee,COUNT(*) FROM E1_analytics WHERE Match_First_YCTime BETWEEN '15' AND '30' GROUP BY Referee ORDER BY COUNT(*) DESC")
thirty_and45 <- sqldf("SELECT Referee,COUNT(*) FROM E1_analytics WHERE Match_First_YCTime BETWEEN '30' AND '45' GROUP BY Referee ORDER BY COUNT(*) DESC")
...
write.xlsx(fifteen_and30,'Analytics/E1/RefereeFirstCard_e1.xlsx', sheetName = "fifteen_and30", append = TRUE)
...
Hfifteen_and30 <- sqldf("SELECT HomeTeam,COUNT(*) FROM E1_analytics WHERE Home_First_YCTime BETWEEN '15' AND '30' GROUP BY HomeTeam ORDER BY COUNT(*) DESC")
Hthirty_and45 <- sqldf("SELECT HomeTeam,COUNT(*) FROM E1_analytics WHERE Home_First_YCTime BETWEEN '30' AND '45' GROUP BY HomeTeam ORDER BY COUNT(*) DESC")
...
Afifteen_and30 <- sqldf("SELECT AwayTeam,COUNT(*) FROM E1_analytics WHERE Away_First_YCTime BETWEEN '15' AND '30' GROUP BY AwayTeam ORDER BY COUNT(*) DESC")
Athirty_and45 <- sqldf("SELECT AwayTeam,COUNT(*) FROM E1_analytics WHERE Away_First_YCTime BETWEEN '30' AND '45' GROUP BY AwayTeam ORDER BY COUNT(*) DESC")
...
write.xlsx(Hfifteen_and30,'Analytics/E1/TeamFirstCard_e1.xlsx', sheetName = "Hfifteen_and30", append = TRUE)
...
write.xlsx(Afifteen_and30,'Analytics/E1/TeamFirstCard_e1.xlsx', sheetName = "Afifteen_and30", append = TRUE)
...
SC0Team_goalmins <- sqldf("SELECT HomeTeam,SUM(TGM),SUM(TGM)/30 from SC0Team_goalminshomeaway GROUP BY HomeTeam ORDER BY SUM(TGM) DESC")
...
SC0Team_Bookings <- sqldf("SELECT HomeTeam,SUM(TBookings),SUM(TBookings)/30 from SC0Team_Bookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TBookings) DESC")
...
SC0Team_CrossBookings <- sqldf("SELECT HomeTeam,SUM(TCrossBookings),SUM(TCrossBookings)/30 from SC0Team_CrossBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TCrossBookings) DESC")
...
SC0Team_TGMXcorners <- sqldf("SELECT HomeTeam,SUM(TTGMXcorners),SUM(TTGMXcorners)/30 from SC0Team_TGMXcornershomeaway GROUP BY HomeTeam ORDER BY SUM(TTGMXcorners) DESC")
...
SC0Team_MultiBookings <- sqldf("SELECT HomeTeam,SUM(TMultiBookings),SUM(TMultiBookings)/30 from SC0Team_MultiBookingshomeaway GROUP BY HomeTeam ORDER BY SUM(TMultiBookings) DESC")
...
fifteen_and30 <- sqldf("SELECT Referee,COUNT(*) FROM SC0_analytics WHERE Match_First_YCTime BETWEEN '15' AND '30' GROUP BY Referee ORDER BY COUNT(*) DESC")
thirty_and45 <- sqldf("SELECT Referee,COUNT(*) FROM SC0_analytics WHERE Match_First_YCTime BETWEEN '30' AND '45' GROUP BY Referee ORDER BY COUNT(*) DESC")
...
write.xlsx(fifteen_and30,'Analytics/SC0/RefereeFirstCard_sc0.xlsx', sheetName = "fifteen_and30", append = TRUE)
...
Hfifteen_and30 <- sqldf("SELECT HomeTeam,COUNT(*) FROM SC0_analytics WHERE Home_First_YCTime BETWEEN '15' AND '30' GROUP BY HomeTeam ORDER BY COUNT(*) DESC")
Hthirty_and45 <- sqldf("SELECT HomeTeam,COUNT(*) FROM SC0_analytics WHERE Home_First_YCTime BETWEEN '30' AND '45' GROUP BY HomeTeam ORDER BY COUNT(*) DESC")
...
Afifteen_and30 <- sqldf("SELECT AwayTeam,COUNT(*) FROM SC0_analytics WHERE Away_First_YCTime BETWEEN '15' AND '30' GROUP BY AwayTeam ORDER BY COUNT(*) DESC")
Athirty_and45 <- sqldf("SELECT AwayTeam,COUNT(*) FROM SC0_analytics WHERE Away_First_YCTime BETWEEN '30' AND '45' GROUP BY AwayTeam ORDER BY COUNT(*) DESC")
...
write.xlsx(Hfifteen_and30,'Analytics/SC0/TeamFirstCard_sc0.xlsx', sheetName = "Hfifteen_and30", append = TRUE)
...
write.xlsx(Afifteen_and30,'Analytics/SC0/TeamFirstCard_sc0.xlsx', sheetName = "Afifteen_and30", append = TRUE)
