...
e0_T_HFYC <- sum(E0_matchfirstyc$Home_first_GoalTime)

e0_T_AFYC <- sum(E0_matchfirstyc$Away_first_GoalTime)
...
e0_home_fhyc <- aggregate(E0_matchfirstyc$Home_first_GoalTime, by = list(E0_matchfirstyc$HomeTeam), FUN = sum)
e0_away_fayc <- aggregate(E0_matchfirstyc$Away_first_GoalTime, by = list(E0_matchfirstyc$AwayTeam), FUN = sum)
...
e0_home_fycc <- aggregate(E0_matchfirstyc$Away_first_GoalTime, by = list(E0_matchfirstyc$HomeTeam), FUN = sum)
e0_away_fycc <- aggregate(E0_matchfirstyc$Home_first_GoalTime, by = list(E0_matchfirstyc$AwayTeam), FUN = sum)
...
unlink('Analytics/BIGFIVE/PoissonFirstGoalanalysis.xlsx')
write.xlsx(E0_matchfirstyc_fixtures_yc,"Analytics/BIGFIVE/PoissonFirstGoalanalysis.xlsx", sheetName = "E0")
###################################################################################################################################################################################
###################################################################################################################################################################################
#D1
...
d1_T_HFYC <- sum(D1_matchfirstyc$Home_first_GoalTime)

d1_T_AFYC <- sum(D1_matchfirstyc$Away_first_GoalTime)
...
d1_home_fhyc <- aggregate(D1_matchfirstyc$Home_first_GoalTime, by = list(D1_matchfirstyc$HomeTeam), FUN = sum)
d1_away_fayc <- aggregate(D1_matchfirstyc$Away_first_GoalTime, by = list(D1_matchfirstyc$AwayTeam), FUN = sum)
...
d1_home_fycc <- aggregate(D1_matchfirstyc$Away_first_GoalTime, by = list(D1_matchfirstyc$HomeTeam), FUN = sum)
d1_away_fycc <- aggregate(D1_matchfirstyc$Home_first_GoalTime, by = list(D1_matchfirstyc$AwayTeam), FUN = sum)
...
write.xlsx(D1_matchfirstyc_fixtures_yc,"Analytics/BIGFIVE/PoissonFirstGoalanalysis.xlsx", sheetName = "D1", append = TRUE)
######################################################################################################################################################################
######################################################################################################################################################################
#I1
...
i1_T_HFYC <- sum(I1_matchfirstyc$Home_first_GoalTime)

i1_T_AFYC <- sum(I1_matchfirstyc$Away_first_GoalTime)
...
i1_home_fhyc <- aggregate(I1_matchfirstyc$Home_first_GoalTime, by = list(I1_matchfirstyc$HomeTeam), FUN = sum)
i1_away_fayc <- aggregate(I1_matchfirstyc$Away_first_GoalTime, by = list(I1_matchfirstyc$AwayTeam), FUN = sum)
...
i1_home_fycc <- aggregate(I1_matchfirstyc$Away_first_GoalTime, by = list(I1_matchfirstyc$HomeTeam), FUN = sum)
i1_away_fycc <- aggregate(I1_matchfirstyc$Home_first_GoalTime, by = list(I1_matchfirstyc$AwayTeam), FUN = sum)
...
write.xlsx(I1_matchfirstyc_fixtures_yc,"Analytics/BIGFIVE/PoissonFirstGoalanalysis.xlsx", sheetName = "I1", append = TRUE)
#######################################################################################################################################################################
#######################################################################################################################################################################
#SP1
...
sp1_T_HFYC <- sum(SP1_matchfirstyc$Home_first_GoalTime)

sp1_T_AFYC <- sum(SP1_matchfirstyc$Away_first_GoalTime)
...
sp1_home_fhyc <- aggregate(SP1_matchfirstyc$Home_first_GoalTime, by = list(SP1_matchfirstyc$HomeTeam), FUN = sum)
sp1_away_fayc <- aggregate(SP1_matchfirstyc$Away_first_GoalTime, by = list(SP1_matchfirstyc$AwayTeam), FUN = sum)
...
sp1_home_fycc <- aggregate(SP1_matchfirstyc$Away_first_GoalTime, by = list(SP1_matchfirstyc$HomeTeam), FUN = sum)
sp1_away_fycc <- aggregate(SP1_matchfirstyc$Home_first_GoalTime, by = list(SP1_matchfirstyc$AwayTeam), FUN = sum)
...
write.xlsx(SP1_matchfirstyc_fixtures_yc,"Analytics/BIGFIVE/PoissonFirstGoalanalysis.xlsx", sheetName = "SP1", append = TRUE)
#############################################################################################################################################################################
#############################################################################################################################################################################
...
f1_T_HFYC <- sum(F1_matchfirstyc$Home_first_GoalTime)

f1_T_AFYC <- sum(F1_matchfirstyc$Away_first_GoalTime)
...
f1_home_fhyc <- aggregate(F1_matchfirstyc$Home_first_GoalTime, by = list(F1_matchfirstyc$HomeTeam), FUN = sum)
f1_away_fayc <- aggregate(F1_matchfirstyc$Away_first_GoalTime, by = list(F1_matchfirstyc$AwayTeam), FUN = sum)
...
f1_home_fycc <- aggregate(F1_matchfirstyc$Away_first_GoalTime, by = list(F1_matchfirstyc$HomeTeam), FUN = sum)
f1_away_fycc <- aggregate(F1_matchfirstyc$Home_first_GoalTime, by = list(F1_matchfirstyc$AwayTeam), FUN = sum)
...
write.xlsx(F1_matchfirstyc_fixtures_yc,"Analytics/BIGFIVE/PoissonFirstGoalanalysis.xlsx", sheetName = "F1", append = TRUE)
####################################################################################################################################################################################
####################################################################################################################################################################################
###############
#OTHER LEAGUES#
...
b1_T_HFYC <- sum(B1_matchfirstyc$Home_first_GoalTime)

b1_T_AFYC <- sum(B1_matchfirstyc$Away_first_GoalTime)
...
b1_home_fhyc <- aggregate(B1_matchfirstyc$Home_first_GoalTime, by = list(B1_matchfirstyc$HomeTeam), FUN = sum)
b1_away_fayc <- aggregate(B1_matchfirstyc$Away_first_GoalTime, by = list(B1_matchfirstyc$AwayTeam), FUN = sum)
...
b1_home_fycc <- aggregate(B1_matchfirstyc$Away_first_GoalTime, by = list(B1_matchfirstyc$HomeTeam), FUN = sum)
b1_away_fycc <- aggregate(B1_matchfirstyc$Home_first_GoalTime, by = list(B1_matchfirstyc$AwayTeam), FUN = sum)
...
unlink('Analytics/OTHERLEAGUES/PoissonFirstGoalanalysis.xlsx')
write.xlsx(B1_matchfirstyc_fixtures_yc,"Analytics/OTHERLEAGUES/PoissonFirstGoalanalysis.xlsx", sheetName = "B1")
######################################################################################################################################################################
######################################################################################################################################################################
#D2
...
d2_T_HFYC <- sum(D2_matchfirstyc$Home_first_GoalTime)

d2_T_AFYC <- sum(D2_matchfirstyc$Away_first_GoalTime)
...
d2_home_fhyc <- aggregate(D2_matchfirstyc$Home_first_GoalTime, by = list(D2_matchfirstyc$HomeTeam), FUN = sum)
d2_away_fayc <- aggregate(D2_matchfirstyc$Away_first_GoalTime, by = list(D2_matchfirstyc$AwayTeam), FUN = sum)
...
d2_home_fycc <- aggregate(D2_matchfirstyc$Away_first_GoalTime, by = list(D2_matchfirstyc$HomeTeam), FUN = sum)
d2_away_fycc <- aggregate(D2_matchfirstyc$Home_first_GoalTime, by = list(D2_matchfirstyc$AwayTeam), FUN = sum)
...
write.xlsx(D2_matchfirstyc_fixtures_yc,"Analytics/OTHERLEAGUES/PoissonFirstGoalanalysis.xlsx", sheetName = "D2", append = TRUE)
###########################################################################################################################################################################
###########################################################################################################################################################################
#E1
...
e1_T_HFYC <- sum(E1_matchfirstyc$Home_first_GoalTime)

e1_T_AFYC <- sum(E1_matchfirstyc$Away_first_GoalTime)
...
e1_home_fhyc <- aggregate(E1_matchfirstyc$Home_first_GoalTime, by = list(E1_matchfirstyc$HomeTeam), FUN = sum)
e1_away_fayc <- aggregate(E1_matchfirstyc$Away_first_GoalTime, by = list(E1_matchfirstyc$AwayTeam), FUN = sum)
...
e1_home_fycc <- aggregate(E1_matchfirstyc$Away_first_GoalTime, by = list(E1_matchfirstyc$HomeTeam), FUN = sum)
e1_away_fycc <- aggregate(E1_matchfirstyc$Home_first_GoalTime, by = list(E1_matchfirstyc$AwayTeam), FUN = sum)
...
write.xlsx(E1_matchfirstyc_fixtures_yc,"Analytics/OTHERLEAGUES/PoissonFirstGoalanalysis.xlsx", sheetName = "E1", append = TRUE)
##############################################################################################################################################################################
##############################################################################################################################################################################
#SC2
...
#
# sc0_T_HFYC <- sum(SC0_matchfirstyc$Home_first_GoalTime)
#
# sc0_T_AFYC <- sum(SC0_matchfirstyc$Away_first_GoalTime)
#
...
# }
#
# sc0_home_fhyc <- aggregate(SC0_matchfirstyc$Home_first_GoalTime, by = list(SC0_matchfirstyc$HomeTeam), FUN = sum)
# sc0_away_fayc <- aggregate(SC0_matchfirstyc$Away_first_GoalTime, by = list(SC0_matchfirstyc$AwayTeam), FUN = sum)
#
#
...
#
# sc0_home_fycc <- aggregate(SC0_matchfirstyc$Away_first_GoalTime, by = list(SC0_matchfirstyc$HomeTeam), FUN = sum)
# sc0_away_fycc <- aggregate(SC0_matchfirstyc$Home_first_GoalTime, by = list(SC0_matchfirstyc$AwayTeam), FUN = sum)
